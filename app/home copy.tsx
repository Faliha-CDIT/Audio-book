...
export default function AudioBookApp() {
  ...
  const bookCovers = [
    // require("../assets/images/Book-1.jpg"),
    require("../assets/images/Book-2.jpg"),
    require("../assets/images/Book-3.jpg"),
    require("../assets/images/Book-4.jpg"),
    require("../assets/images/Book-5.jpg"),
    require("../assets/images/Book-6.jpg"),
    require("../assets/images/Book-7.jpg"),
    require("../assets/images/Book-8.jpg"),
    require("../assets/images/Book-9.jpg"),
  ]
    ...
    <ScrollView style={styles.homeContainer}>
      <View style={[styles.heroSection, { paddingHorizontal: 0 }]}>
        ...
        <View style={styles.sliderContainer}>
          ...
          >
            {bookCovers.map((src, i) => (
              <View key={i} style={{ width: SCREEN_WIDTH }}>
                <Image source={src} style={styles.sliderImage} resizeMode="cover" />
              </View>
            ))}
          </ScrollView>
      ...
      <View style={styles.featuredSection}>
        ...
        <View style={styles.cardGrid}>
          <TouchableOpacity style={styles.featuredCardTeal} onPress={() => router.push("/periodic-table")}>
